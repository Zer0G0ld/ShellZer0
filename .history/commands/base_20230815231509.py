...
def top():
    try:
        if os.name == 'posix':
            ...
            performancePs = 'Erro ao tentar ver o desempenho do sistema.' + str(error)
    except Exception as error:
        performance = 'Erro ao tentar ver o desempenho do sistema' + str(error)
        return performance
...
def ps():
    try:
        if os.name == 'posix':
            ...
            process = 'Não consegui ver os processos do sistemas.'
    except Exception as error:
        processError = 'Não consegui ver os processos do sistemas.' + str(error)return processError
